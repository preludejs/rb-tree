...
function balance(_: any) {
  switch (true) {
    ...
    case _?.[0] === 2 && _?.[1]?.[0] === 1 && _?.[1]?.[1]?.[0] === 1:
      return [1, [2, _[1][1][1], _[1][1][2], _[1][1][3]], _[1][2], [2, _[1][3], _[2], _[3]]]

    // (balance B (T R a x (T R b y c)) z d) = T R (T B a x b) y (T B c z d)
    case _?.[0] === 2 && _?.[1]?.[0] === 1 && _?.[1]?.[3]?.[0] === 1:
      return [1, [2, _[1][1], _[1][2], _[1][3][1]], _[1][3][2], [2, _[1][3][3], _[2], _[3]]]

    // (balance B a x (T R (T R b y c) z d)) = T R (T B a x b) y (T B c z d)
    case _?.[0] === 2 && _?.[3]?.[0] === 1 && _?.[3]?.[1]?.[0] === 1:
      return [1, [2, _[1], _[2], _[3][1][1]], _[3][1][2], [2, _[3][1][3], _[3][2], _[3][3]]]

    // (balance B a x (T R b y (T R c z d))) = T R (T B a x b) y (T B c z d)
    case _?.[0] === 2 && _?.[3]?.[0] === 1 && _?.[3]?.[3]?.[0] === 1:
      return [1, [2, _[1], _[2], _[3][1]], _[3][2], [2, _[3][3][1], _[3][3][2], _[3][3][3]]]

    // (balance BB a x (T R (T R b y c) z d)) = T B (T B a x b) y (T B c z d)
    case _?.[0] === 3 && _?.[3]?.[0] === 1 && _?.[3]?.[1]?.[0] === 1:
      return [2, [2, _[1], _[2], _[3][1][1]], _[3][1][2], [2, _[3][1][3], _[3][2], _[3][3]]]

    // (balance BB (T R a x (T R b y c)) z d) = T B (T B a x b) y (T B c z d)
    case _?.[0] === 3 && _?.[1]?.[0] === 1 && _?.[1]?.[3]?.[0] === 1:
      return [2, [2, _[1][1], _[1][2], _[1][3][1]], _[1][3][2], [2, _[1][3][3], _[2], _[3]]]
